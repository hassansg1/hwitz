...
use App\Models\Devices\DeviceInterface;
...
class Token extends Model {
    ...
    {	
    	$status = isset($this->attributes['status']) ? '<span class="label label-success">Active</span>' : '<span class="label label-warning">In Active</span>';
    	return $status;
    }

    public function getFormattedActiveAttribute() 
    {
    	$status = isset($this->attributes['active']) && $this->attributes['active'] ? '<span class="label label-success">Active</span>' : '<span class="label label-warning">In Active</span>';
      	return $status;
    }
	...
	public function historyUser(){
		return $this->belongsTo(User::class,'user_history');
	}
}
