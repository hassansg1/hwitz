  ...
  <section class="login-box container d-flex justify-content-center flex-column">
    <div>
      <div class="login-container">
        ...
        <h3 class="fw-bolder">Reset your password</h3>
      </div>
      ...
      <form class="form-box" action="{{ route('password.update') }}" method="POST">
        ...
        <div class="mb-3">
          ...
          <div class="form-control">
            <input name="email" required autofocus type="email" name="email" :value="old('email', $request->email)"  class="form-control-input w-100" /> 
          </div>
          @if ($errors->has('email'))
        ...
        <div class="mb-3">
            ...
            <div class="form-control" style="display: flex; justify-content: space-between" >
                <input name="password" id="password-field" required type="password" class="form-control-input w-100" />
                <svg
        ...
        <div class="mb-3">
            ...
            <div class="form-control" style="display: flex; justify-content: space-between" >
                <input name="password_confirmation" id="password-field" required type="password" class="form-control-input w-100" />
                <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="20"
                    height="20"
