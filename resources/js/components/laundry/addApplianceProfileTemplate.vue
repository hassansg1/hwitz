<template>
    <div>
      <div
        ...
        :id="'addApplianceProfileTemplatePopup'+id"
        tabindex="-1"
  ...
  import exceptionalDiscountPopup from "./exceptionalDiscountPopup.vue";
  ...
  export default {
    ...
    methods : {
      ...
      createBroadcastTemplate(){
        this.showLoader();
        this.form
          .post("/api/saveApplianceProfileTemplate")
          .then(({ data }) => {
  ...
  <style>
    ...
    .flex th {font-weight:normal;text-align: center;padding-left:5px !important;border:none !important;}
