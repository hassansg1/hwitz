      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div>
              <div class="h3 mb-13">
                Assign Staff to Entry Notification for
                <span>Charlotte Garcia</span>
              </div>
              <p class="text-normal color-secondary mb-72">
                Select the staff you want to assign this building
              </p>
              ...
              <div class="d-flex justify-content-end">
                <button class="btn btn-primary">Assign Building</button>
              </div>
            </div>
          </div>
        </div>
