      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div>
              <div class="h3 mb-13">Assign User to <span>238 N Pine</span></div>
              <p class="text-normal color-secondary mb-72">
                Select the staff you want yo assign to the building
              </p>
              ...
              <div class="d-flex justify-content-center">
                <button class="btn btn-primary">Assign to residents</button>
              </div>
            </div>
          </div>
        </div>
