      ...
      <div class="table-responsive mb-28">
        <table>
          ...
          <tr v-for="data in dataArray.data" class="border_bottom">
            ...
            <td>
              <span class="text-medium" v-if="data.screen">{{data.screen.name}}</span>
            ...
            <td>
              <span class="text-medium" v-if="data.event_type">{{ data.event_type  }}</span>
            </td>
            <td>
              <span class="text-medium" v-if="data.event_data">{{ data.event_data  }}</span>
            </td>
            <td>
              <span class="text-medium" v-if="data.timestamp ">{{ formatDateTime(data.timestamp) }}</span>
            </td>
          </tr>
        </table>
      </div>
